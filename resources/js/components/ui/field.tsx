    ...
    return (
        <Label
            className={cn(
                ...
                'has-[>[data-slot=field]]:w-full has-[>[data-slot=field]]:flex-col has-[>[data-slot=field]]:rounded-xl has-[>[data-slot=field]]:border *:data-[slot=field]:px-4 *:data-[slot=field]:py-5',
                'has-data-[state=checked]:border-brand-neutral-1000 has-[>[data-slot=field]]:has-data-[state=checked]:border-2 dark:has-data-[state=checked]:bg-primary/10',
                className,
            )}
